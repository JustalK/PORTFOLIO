...
module.exports = {
    create_server: function (name, port) {
        var server = express();
        server.set('port', port);
        server.set('name', name);
        return server;
    },
    adding_route: function (filename_routes, routes_url, server) {
        var routes = require('./routes/' + filename_routes);
        server.use(routes_url, routes);
    },
    start: function (name, host, port) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    var server = module.exports.create_server(name, port);
